...
cMolde5 := ( "C:\Covid19Tab\1.4\Covid19Tab\tmp\molde5.dbf" )
cFuse := ( "C:\Covid19Tab\1.4\Covid19Tab\tmp\temp_covid19alfa.txt" )
FErase( "C:\Covid19Tab\1.4\Covid19Tab\tmp\data5.txt" )
nHandle := FCreate( "C:\Covid19Tab\1.4\Covid19Tab\tmp\data5.txt" )
FWrite ( nHandle, "1.00" )
Fclose ( nHandle )
crlf := chr(13) + chr(10)
...
if cRightString = ".00"
nH := FOpen( "C:\Covid19Tab\1.4\Covid19Tab\tmp\data5.txt", FO_WRITE)
FWrite ( nH, cPercent )
FWrite ( nH, crlf )
Fclose ( nH )
endif
...
replace ano_epi_no with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 67 ) ) ) )
...
replace dt_sin_pri with ctod( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 23 ) ) ) )
...
replace dt_coleta with ctod( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 31 ) ) ) )
