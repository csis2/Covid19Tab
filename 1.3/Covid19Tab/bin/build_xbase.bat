...
echo.
cecho {0a}
copy C:\Covid19Tab\1.3\Covid19Tab\src\*.prg c:\hb30\bin\
if %errorlevel% equ 0 (
...
cd\
cd C:\Covid19Tab\1.3\Covid19Tab\bin\
cecho {0b}%date:~-10,2%/%date:~-7,2%/%date:~-4,4% %time:~0,2%:%time:~3,2%:%time:~6,2%-------Copiando os arquivos compilados...
echo.
cecho {0a}
copy C:\hb30\bin\getdata.exe C:\Covid19Tab\1.3\Covid19Tab\bin\getdata.exe
if %errorlevel% equ 0 (
...
cecho {0a}
copy C:\hb30\bin\field_creation.exe C:\Covid19Tab\1.3\Covid19Tab\bin\field_creation.exe
if %errorlevel% equ 0 (
cecho {0b}%date:~-10,2%/%date:~-7,2%/%date:~-4,4% %time:~0,2%:%time:~3,2%:%time:~6,2%-------Arquivo copiado.
echo.
) else (
...
cecho {0a}
copy C:\hb30\bin\load_fields.exe C:\Covid19Tab\1.3\Covid19Tab\bin\load_fields.exe
if %errorlevel% equ 0 (
cecho {0b}%date:~-10,2%/%date:~-7,2%/%date:~-4,4% %time:~0,2%:%time:~3,2%:%time:~6,2%-------Arquivo copiado.
echo.
) else (
...
cecho {0a}
copy C:\hb30\bin\DBF_file.exe C:\Covid19Tab\1.3\Covid19Tab\bin\DBF_file.exe
if %errorlevel% equ 0 (
cecho {0b}%date:~-10,2%/%date:~-7,2%/%date:~-4,4% %time:~0,2%:%time:~3,2%:%time:~6,2%-------Arquivo copiado.
echo.
) else (
...
cecho {0a}
copy C:\hb30\bin\rwtext.exe C:\Covid19Tab\1.3\Covid19Tab\bin\rwtext.exe
if %errorlevel% equ 0 (
cecho {0b}%date:~-10,2%/%date:~-7,2%/%date:~-4,4% %time:~0,2%:%time:~3,2%:%time:~6,2%-------Arquivo copiado.
echo.
) else (
...
cecho {0a}
copy C:\hb30\bin\transfer2.exe C:\Covid19Tab\1.3\Covid19Tab\bin\transfer2.exe
if %errorlevel% equ 0 (
cecho {0b}%date:~-10,2%/%date:~-7,2%/%date:~-4,4% %time:~0,2%:%time:~3,2%:%time:~6,2%-------Arquivo copiado.
echo.
) else (
...
cecho {0a}
copy C:\hb30\bin\detect.exe C:\Covid19Tab\1.3\Covid19Tab\bin\detect.exe
if %errorlevel% equ 0 (
cecho {0b}%date:~-10,2%/%date:~-7,2%/%date:~-4,4% %time:~0,2%:%time:~3,2%:%time:~6,2%-------Arquivo copiado.
echo.
) else (
...
cecho {0a}
copy C:\hb30\bin\index.exe C:\Covid19Tab\1.3\Covid19Tab\bin\index.exe
if %errorlevel% equ 0 (
cecho {0b}%date:~-10,2%/%date:~-7,2%/%date:~-4,4% %time:~0,2%:%time:~3,2%:%time:~6,2%-------Arquivo copiado.
echo.
) else (
...
cecho {0a}
copy C:\hb30\bin\epidemio.exe C:\Covid19Tab\1.3\Covid19Tab\bin\epidemio.exe
if %errorlevel% equ 0 (
cecho {0b}%date:~-10,2%/%date:~-7,2%/%date:~-4,4% %time:~0,2%:%time:~3,2%:%time:~6,2%-------Arquivo copiado.
echo.
) else (
...
cecho {0a}
copy C:\hb30\bin\fill_week.exe C:\Covid19Tab\1.3\Covid19Tab\bin\fill_week.exe
if %errorlevel% equ 0 (
cecho {0b}%date:~-10,2%/%date:~-7,2%/%date:~-4,4% %time:~0,2%:%time:~3,2%:%time:~6,2%-------Arquivo copiado.
echo.
) else (
...
cecho {0a}
copy C:\hb30\bin\save.exe C:\Covid19Tab\1.3\Covid19Tab\bin\save.exe
if %errorlevel% equ 0 (
cecho {0b}%date:~-10,2%/%date:~-7,2%/%date:~-4,4% %time:~0,2%:%time:~3,2%:%time:~6,2%-------Arquivo copiado.
echo.
) else (
...
cecho {0a}
copy C:\hb30\bin\testa_dbf.exe C:\Covid19Tab\1.3\Covid19Tab\bin\testa_dbf.exe
if %errorlevel% equ 0 (
cecho {0b}%date:~-10,2%/%date:~-7,2%/%date:~-4,4% %time:~0,2%:%time:~3,2%:%time:~6,2%-------Arquivo copiado.
echo.
) else (
