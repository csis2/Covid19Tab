...
namespace Covid19Tab
{
    public class Clear
    {
        ...
        {               
            ...
            startInfo1.Arguments = "/C del C:\\Covid19Tab\\1.3\\Covid19Tab\\tmp\\*.txt";
            ...
            startInfo3.Arguments = "/C del C:\\Covid19Tab\\1.3\\Covid19Tab\\tmp\\*.ntx";
            ...
            {
                File.Delete(@"C:\Covid19Tab\1.3\Covid19Tab\tmp\molde1.dbf");
                File.Delete(@"C:\Covid19Tab\1.3\Covid19Tab\tmp\molde2.dbf");
                File.Delete(@"C:\Covid19Tab\1.3\Covid19Tab\tmp\molde4.dbf");
                File.Delete(@"C:\Covid19Tab\1.3\Covid19Tab\tmp\weeks_table.dbf");
                File.Delete(@"C:\Covid19Tab\1.3\Covid19Tab\tmp\comp_return.prn");
            });
            task10.Wait();            
        }
    }
