        ...
        public void heading()
        {
            ...
            switch (Program.cModeloPadrao)
            {
                case "MP1":
                    ...
                    {
                        var lines2a = System.IO.File.ReadAllLines("C:\\Covid19Tab\\1.7\\Covid19Tab\\tmp\\temp_covid19.txt");
                        System.IO.File.WriteAllLines("C:\\Covid19Tab\\1.7\\Covid19Tab\\tmp\\temp_covid19.txt", lines2a.Skip(1).ToArray());
                    });
                    task1a.Wait();
                                        
                    Task task2a = Task.Run(() =>
                    {
                        string strTextFileName = "C:\\Covid19Tab\\1.7\\Covid19Tab\\tmp\\temp_covid19.txt";
                    ...
                    {
                        File.Move("C:\\Covid19Tab\\1.7\\Covid19Tab\\tmp\\temp_covid19.txt", "C:\\Covid19Tab\\1.7\\Covid19Tab\\tmp\\temp_covid19alfa.txt");
                        string lineswitch = File.ReadLines("C:\\Covid19Tab\\1.7\\Covid19Tab\\tmp\\temp_covid19alfa.txt").First();
                        using (StreamWriter sw = File.CreateText("C:\\Covid19Tab\\1.7\\Covid19Tab\\tmp\\heading2.txt"))
                        {
                ...
                case "MP2":
                    ...
                    {
                    var lines = System.IO.File.ReadAllLines("C:\\Covid19Tab\\1.7\\Covid19Tab\\tmp\\temp_covid19.txt");
                    System.IO.File.WriteAllLines("C:\\Covid19Tab\\1.7\\Covid19Tab\\tmp\\temp_covid19.txt", lines.Skip(1).ToArray());
                    });
                    task1b.Wait();
                ...
                case "MP3":
                    ...
                    Task task1 = Task.Run(() =>
                    {
                    var lines2 = System.IO.File.ReadAllLines("C:\\Covid19Tab\\1.7\\Covid19Tab\\tmp\\temp_covid19.txt");
                    System.IO.File.WriteAllLines("C:\\Covid19Tab\\1.7\\Covid19Tab\\tmp\\temp_covid19.txt", lines2.Skip(1).ToArray());
                    });
                    task1.Wait();
                    ...
                    string strTextFileName = "C:\\Covid19Tab\\1.7\\Covid19Tab\\tmp\\temp_covid19.txt";
                    int iInsertAtLineNumber = 0;
                    string strTextToInsert = "nu_notific,dt_notific,cpf,nm_pacient,sexo,raca_cor,dt_nasc,nome_mae,cbo,logradouro,bairro,cep,id_mn_resi,munic_res,region_res,macroresid,uf,munic_not,diabetes,cardio,d_resp,imunosup,gestante,puerpera,dt_sin_pri,classific,criterio,evolucao,dt_evoluc,cnes_not,res_teste,tp_teste,dt_coleta,est_teste,profissio,fonte,idade";
                    ArrayList lines = new ArrayList();
                    StreamReader rdr = new StreamReader( strTextFileName );
                    string line;
            ...
            if (!File.Exists(@"C:\covid19tab\1.7\covid19tab\tmp\heading2.txt"))
            {
                Program.nErro = 1;
