...
nHandle := FCreate( "C:\Covid19Tab\2.1\Covid19Tab\tmp\data6.txt" )
...
if File( "C:\Covid19Tab\2.1\Covid19Tab\baseDBF\MUNICNET.DBF" ) = .F.
nErrorFile = 1
else
use "C:\Covid19Tab\2.1\Covid19Tab\baseDBF\MUNICNET.DBF"
nRecs = reccount()
close
if nRecs = 0
nErrorFile = 1
...
if File( "C:\Covid19Tab\2.1\Covid19Tab\baseDBF\REGIONET.DBF" ) = .F.
nErrorFile = 1
else
use "C:\Covid19Tab\2.1\Covid19Tab\baseDBF\REGIONET.DBF"
nRecs = reccount()
close
if nRecs = 0
nErrorFile = 1
...
if File( "C:\Covid19Tab\2.1\Covid19Tab\baseDBF\UF.DBF" ) = .F.
nErrorFile = 1
else
use "C:\Covid19Tab\2.1\Covid19Tab\baseDBF\UF.DBF"
nRecs = reccount()
close
if nRecs = 0
nErrorFile = 1
