...
cMolde5 := ( "C:\Covid19Tab\2.1\Covid19Tab\tmp\molde5.dbf" )
cFuse := ( "C:\Covid19Tab\2.1\Covid19Tab\tmp\temp_covid19alfa.txt" )
FErase( "C:\Covid19Tab\2.1\Covid19Tab\tmp\data5.txt" )
nHandle := FCreate( "C:\Covid19Tab\2.1\Covid19Tab\tmp\data5.txt" )
FWrite ( nHandle, "1.00" )
Fclose ( nHandle )
crlf := chr(13) + chr(10)
...
nVezes ++
if nVezes = 1
nH := FOpen( "C:\Covid19Tab\2.1\Covid19Tab\tmp\data5.txt", FO_WRITE)
FWrite ( nH, cPercent )
FWrite ( nH, crlf )
Fclose ( nH )
endif
