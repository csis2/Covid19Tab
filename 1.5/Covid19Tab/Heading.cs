        ...
        public void heading()
        {
            ...
            switch (Program.cModeloPadrao)
            {
                case "MP1":
                    ...
                    {
                        var lines2a = System.IO.File.ReadAllLines("C:\\Covid19Tab\\1.5\\Covid19Tab\\tmp\\temp_covid19.txt");
                        System.IO.File.WriteAllLines("C:\\Covid19Tab\\1.5\\Covid19Tab\\tmp\\temp_covid19.txt", lines2a.Skip(1).ToArray());
                    });
                    task1a.Wait();
                                        
                    Task task2a = Task.Run(() =>
                    {
                        string strTextFileName = "C:\\Covid19Tab\\1.5\\Covid19Tab\\tmp\\temp_covid19.txt";
                    ...
                    {
                        File.Move("C:\\Covid19Tab\\1.5\\Covid19Tab\\tmp\\temp_covid19.txt", "C:\\Covid19Tab\\1.5\\Covid19Tab\\tmp\\temp_covid19alfa.txt");
                        string lineswitch = File.ReadLines("C:\\Covid19Tab\\1.5\\Covid19Tab\\tmp\\temp_covid19alfa.txt").First();
                        using (StreamWriter sw = File.CreateText("C:\\Covid19Tab\\1.5\\Covid19Tab\\tmp\\heading2.txt"))
                        {
                ...
                case "MP2":
                    ...
                    {
                    var lines = System.IO.File.ReadAllLines("C:\\Covid19Tab\\1.5\\Covid19Tab\\tmp\\temp_covid19.txt");
                    System.IO.File.WriteAllLines("C:\\Covid19Tab\\1.5\\Covid19Tab\\tmp\\temp_covid19.txt", lines.Skip(1).ToArray());
                    });
                    task1b.Wait();
                    ...
                    Task task2b = Task.Run(() =>
                    {
                        string strTextFileName = "C:\\Covid19Tab\\1.5\\Covid19Tab\\tmp\\temp_covid19.txt";
                        int iInsertAtLineNumber = 0;
                        string strTextToInsert = "nu_notific,dt_notific,cpf,nm_pacient,sexo,raca_cor,dt_nasc,idade,cbo,id_mn_resi,munic_res,region_res,macroresid,uf,dt_sin_pri,diabetes,cardio,d_resp,imunosup,classific,criterio,evolucao,dt_evoluc,cnes_not,res_teste,tp_teste,est_teste,profissio,fonte,clas_sivep,internacao,dt_inter,inter_uti,dt_int_uti,dt_sai_uti,puerpera,hemato,sind_down,hepat_cron,neuro_cron,renal_cron,obesidade,gestante,febre,tosse,dor_gargan,dispneia,desc_resp,saturacao,diarreia,vomito,sup_ventil,out_sint2,condicoes,etnia_ind,out_sint,doen_renal,doen_cromo,sem_epi_si,ano_epi_si,sem_epi_ev,ano_epi_ev,sem_epi_in,ano_epi_in,sem_epi_no,ano_epi_no";
                        ArrayList lines = new ArrayList();
                        StreamReader rdr = new StreamReader(strTextFileName);
                        string line;
                ...
                case "MP3":
                    ...
                    Task task1 = Task.Run(() =>
                    {
                    var lines2 = System.IO.File.ReadAllLines("C:\\Covid19Tab\\1.5\\Covid19Tab\\tmp\\temp_covid19.txt");
                    System.IO.File.WriteAllLines("C:\\Covid19Tab\\1.5\\Covid19Tab\\tmp\\temp_covid19.txt", lines2.Skip(1).ToArray());
                    });
                    task1.Wait();
            ...
            if (!File.Exists(@"C:\covid19tab\1.5\covid19tab\tmp\heading2.txt"))
            {
                Program.nErro = 1;
