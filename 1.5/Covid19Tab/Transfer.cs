...
namespace Covid19Tab
{
    public class Transfer
    {
        ...
        private void Transfer_Thread(object obj)
        {
            ...
            var startinfo = new ProcessStartInfo(@"C:\Covid19Tab\1.5\Covid19Tab\bin\transfer2.exe");
        ...
        {
            {
                ...
                while (t)
                {
                    try
                    {
                        using (StreamReader sr = new StreamReader(@"C:\Covid19Tab\1.5\Covid19Tab\tmp\data5.txt"))
                        {
