    ...
    // subdiretório baseDBF.
    {
        public void finish()
        {
            Task task5 = Task.Run(() =>
            {
                ...
                Program.cFinalName = "C:\\Covid19Tab\\1.9\\Covid19Tab\\baseDBF\\" + Program.cModeloPadrao + "_" + Program.cFileNameWithoutExt + ".dbf";
                if ( File.Exists( Program.cFinalName ) ) {
                    File.Delete(Program.cFinalName);
                    File.Move("C:\\Covid19Tab\\1.9\\Covid19Tab\\tmp\\molde5.dbf", Program.cFinalName);
                }
                else
                {
                    File.Move("C:\\Covid19Tab\\1.9\\Covid19Tab\\tmp\\molde5.dbf", Program.cFinalName);
