...
namespace Covid19Tab
{
    public class LoadFields
    {
        ...
        private void Transfer_Thread(object obj)
        {
            ...
            var startinfo = new ProcessStartInfo(@"C:\Covid19Tab\1.9\Covid19Tab\bin\load_fields.exe");
            switch (Program.cModeloPadrao)
            {
                ...
                case "MP4":
                    ...
                    break;
                case "MP5":
                    startinfo.Arguments = "MP5" + " " + Program.cUf + " " + Program.cDbf_Sinan;
                    break;
            }
        ...
        {
            {
                ...
                while (t)
                {
                    try
                    {
                        using (StreamReader sr = new StreamReader(@"C:\Covid19Tab\1.9\Covid19Tab\tmp\data6.txt"))
                        {
