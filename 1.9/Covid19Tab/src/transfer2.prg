...
cMolde5 := ( "C:\Covid19Tab\1.9\Covid19Tab\tmp\molde5.dbf" )
cFuse := ( "C:\Covid19Tab\1.9\Covid19Tab\tmp\temp_covid19alfa.txt" )
FErase( "C:\Covid19Tab\1.9\Covid19Tab\tmp\data5.txt" )
nHandle := FCreate( "C:\Covid19Tab\1.9\Covid19Tab\tmp\data5.txt" )
FWrite ( nHandle, "1.00" )
Fclose ( nHandle )
crlf := chr(13) + chr(10)
...
nVezes ++
if nVezes = 1
nH := FOpen( "C:\Covid19Tab\1.9\Covid19Tab\tmp\data5.txt", FO_WRITE)
FWrite ( nH, cPercent )
FWrite ( nH, crlf )
Fclose ( nH )
endif
...
nLastPos := hb_RAt ( ";", (cString) )
cLastSubString := substr ( (cString), (nLastPos+1),(nTotalStringSize)-(nLastPos) )
hElements[ 67 ] := ( cLastSubString )

* Transfere os valores armazenados na hash table para o arquivo dbf.
append blank
replace nu_notific with upper ( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 1 ) ) ) )
replace dt_notific with ctod( ( HB_HGET( hElements, 2 ) ) )
replace sexo with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 3 ) ) ) )
replace raca_cor with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 4 ) ) ) )
replace dt_nasc with ctod( ( HB_HGET( hElements, 5 ) ) )
replace idade with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 6 ) ) ) )
replace cbo with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 7 ) ) ) )
replace id_mn_resi with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 8 ) ) ) )
replace munic_res with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 9 ) ) ) )
replace region_res with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 10 ) ) ) )

replace macroresid with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 11 ) ) ) )
replace uf with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 12 ) ) ) )
replace dt_sin_pri with ctod( ( HB_HGET( hElements, 13 ) ) )
replace diabetes with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 14 ) ) ) )
replace cardio with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 15 ) ) ) )
replace d_resp with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 16 ) ) ) )
replace imunosup with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 17 ) ) ) )
replace classific with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 18 ) ) ) )
replace criterio with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 19 ) ) ) )
replace evolucao with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 20 ) ) ) )

replace dt_evoluc with ctod( ( HB_HGET( hElements, 21 ) ) )
replace cnes_not with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 22 ) ) ) )
replace res_teste with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 23 ) ) ) )
replace tp_teste with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 24 ) ) ) )
replace est_teste with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 25 ) ) ) )
replace profissio with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 26 ) ) ) )
replace fonte with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 27 ) ) ) )
replace clas_sivep with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 28 ) ) ) )
replace internacao with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 29 ) ) ) )
replace dt_inter with ctod( ( HB_HGET( hElements, 30 ) ) )

replace inter_uti with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 31 ) ) ) )
replace dt_int_uti with ctod( ( HB_HGET( hElements, 32 ) ) )
replace dt_sai_uti with ctod( ( HB_HGET( hElements, 33 ) ) )
replace puerpera with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 34 ) ) ) )
replace hemato with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 35 ) ) ) )
replace sind_down with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 36 ) ) ) )
replace hepat_cron with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 37 ) ) ) )
replace neuro_cron with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 38 ) ) ) )
replace renal_cron with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 39 ) ) ) )
replace obesidade with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 40 ) ) ) )

replace gestante with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 41 ) ) ) )
replace febre with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 42 ) ) ) )
replace tosse with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 43 ) ) ) )
replace dor_gargan with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 44 ) ) ) )
replace dispneia with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 45 ) ) ) )
replace desc_resp with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 46 ) ) ) )
replace saturacao with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 47 ) ) ) )
replace diarreia with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 48 ) ) ) )
replace vomito with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 49 ) ) ) )
replace sup_ventil with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 50 ) ) ) )

replace out_sint2 with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 51 ) ) ) )
replace condicoes with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 52 ) ) ) )
replace etnia_ind with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 53 ) ) ) )
replace out_sint with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 54 ) ) ) )
replace doen_renal with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 55 ) ) ) )
replace doen_cromo with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 56 ) ) ) )
replace sem_epi_si with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 57 ) ) ) )
replace ano_epi_si with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 58 ) ) ) )
replace sem_epi_ev with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 59 ) ) ) )
replace ano_epi_ev with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 60 ) ) ) )

replace sem_epi_in with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 61 ) ) ) )
replace ano_epi_in with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 62 ) ) ) )
replace sem_epi_no with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 63 ) ) ) )
replace ano_epi_no with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 64 ) ) ) )
replace sem_ep_uti with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 65 ) ) ) )
replace ano_ep_uti with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 67 ) ) ) )
...
* Cria um registro extra no arquivo "molde5.dbf" com o total de registros contidos no arquivo.
append blank
replace cbo with "covid19tab#" + str(nTotalLines)
close
...
replace munic_not with upper( ( HB_HGET( hElements, 17 ) ) )
replace diabetes with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 18 ) ) ) )
replace cardio with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 19 ) ) ) )
replace d_resp with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 20 ) ) ) )

replace imunosup with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 21 ) ) ) )
replace gestante with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 22 ) ) ) )
replace puerpera with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 23 ) ) ) )
replace dt_sin_pri with ctod( ( HB_HGET( hElements, 24 ) ) )
replace classific with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 25 ) ) ) )
replace criterio with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 26 ) ) ) )
replace evolucao with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 27 ) ) ) )
replace dt_evoluc with ctod( ( HB_HGET( hElements, 28 ) ) )
replace cnes_not with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 29 ) ) ) )
replace res_teste with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 30 ) ) ) )

replace tp_teste with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 31 ) ) ) )
replace dt_coleta with ctod( ( HB_HGET( hElements, 32 ) ) )
replace est_teste with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 33 ) ) ) )
replace profissio with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 34 ) ) ) )
replace fonte with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 35 ) ) ) )
replace idade with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 37 ) ) ) )
...
replace munic_res with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 14 ) ) ) )
replace region_res with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 15 ) ) ) )
replace munic_not with upper( ( HB_HGET( hElements, 16 ) ) )
replace diabetes with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 17 ) ) ) )
replace cardio with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 18 ) ) ) )
replace d_resp with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 19 ) ) ) )
replace imunosup with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 20 ) ) ) )

replace gestante with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 21 ) ) ) )
replace puerpera with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 22 ) ) ) )
replace dt_sin_pri with ctod( ( HB_HGET( hElements, 23 ) ) )
replace classific with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 24 ) ) ) )
replace criterio with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 25 ) ) ) )
replace evolucao with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 26 ) ) ) )
replace dt_evoluc with ctod( ( HB_HGET( hElements, 27 ) ) )
replace cnes_not with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 28 ) ) ) )
replace res_teste with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 29 ) ) ) )
replace tp_teste with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 30 ) ) ) )

replace dt_coleta with ctod( ( HB_HGET( hElements, 31 ) ) )
replace est_teste with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 32 ) ) ) )
replace profissio with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 33 ) ) ) )
replace fonte with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 34 ) ) ) )
replace idade with upper( remacent("",hb_UTF8ToStr( HB_HGET( hElements, 36 ) ) ) )
