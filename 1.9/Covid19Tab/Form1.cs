...
namespace Covid19Tab
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string cCheckItem4 = checkedListBox1.GetItemCheckState(3).ToString();
            if (cCheckItem4 == "Checked")
            {
                nChecked++;
                Program.cModeloPadrao = "MP4";
            }
            string cCheckItem5 = checkedListBox1.GetItemCheckState(4).ToString();
            if (cCheckItem5 == "Checked")
            {
                nChecked++;
                Program.cModeloPadrao = "MP5";
            }
