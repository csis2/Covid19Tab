...
namespace Covid19Tab
{
    ...
    // arquivo "heading2.txt", que contém o cabeçalho do arquivo.
    {
        ...
        public void verify()
        {
            ...
            {
                string path = @"c:\covid19tab\2.0\covid19tab\tmp\heading2.txt";
            ...
            if (Program.cModeloPadrao == "MP3" || Program.cModeloPadrao == "MP5")
            {
                string path = @"c:\covid19tab\2.0\covid19tab\tmp\heading2.txt";
                string readText = File.ReadAllText(path);
                string word1 = "nu_notific";
            ...
            if (Program.cModeloPadrao == "MP4")
            {
                string path = @"c:\covid19tab\2.0\covid19tab\tmp\heading2.txt";
                string readText = File.ReadAllText(path);
                string word1 = "num_contat";
                string word2 = "nm_contato";
                string word3 = "status";
                string word4 = "dia10_data";
                string word5 = "not_cnpj";
                Verify.contains1 = readText.Contains(word1);
                Verify.contains2 = readText.Contains(word2);
                Verify.contains3 = readText.Contains(word3);
