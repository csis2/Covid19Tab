...
namespace Covid19Tab
{
    public partial class Form3 : Form
    {
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            startInfo1.Arguments = "/C del C:\\Covid19Tab\\2.0\\Covid19Tab\\set\\version.txt";
            ...
            Task task20 = Task.Run(() =>
            {
                ...
                try
                {
                    wb.DownloadFile("https://raw.githubusercontent.com/csis2/Covid19Tab/master/covid19tab_version.txt", @"c:\covid19tab\2.0\covid19tab\set\version.txt");
            ...
            task21.Wait();
                ...
                if (Program.nError_task == 0)
                {
                    string line1 = File.ReadLines(@"C:\Covid19Tab\2.0\Covid19Tab\set\version.txt").First();
