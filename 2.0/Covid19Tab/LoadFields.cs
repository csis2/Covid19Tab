...
namespace Covid19Tab
{
    public class LoadFields
    {
        ...
        private void Transfer_Thread(object obj)
        {
            ...
            var startinfo = new ProcessStartInfo(@"C:\Covid19Tab\2.0\Covid19Tab\bin\load_fields.exe");
        ...
        {
            {
                ...
                while (t)
                {
                    try
                    {
                        using (StreamReader sr = new StreamReader(@"C:\Covid19Tab\2.0\Covid19Tab\tmp\data6.txt"))
                        {
