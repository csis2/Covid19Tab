...
namespace Covid19Tab
{
    public class PreFiltro
    {
        ...
        private void Transfer_Thread(object obj)
        {
            ...
            var startinfo = new ProcessStartInfo(@"C:\Covid19Tab\2.0\Covid19Tab\bin\filter_one.exe");
        ...
        {
            {
                ...
                while (t)
                {
                    try
                    {
                        using (StreamReader sr = new StreamReader(@"C:\Covid19Tab\2.0\Covid19Tab\tmp\data10.txt"))
                        {
