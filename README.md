...
3.1.4. Procure a pasta onde o arquivo "Covid19Tab_2.0_setup.exe" foi salvo.

![alt text](https://github.com/csis2/Covid19Tab/blob/1.3/img/image4a.jpg)

3.1.5. Execute o arquivo "Covid19Tab_2.0_setup.exe".
...
3.2.2. Após clicar no link, será carregada a página do release selecionado. Clique no link "Covid19Tab_versao_2.0.rar".
...
![Link para download do modelo padrão MP2 versão 1.3](https://github.com/csis2/Covid19Tab/blob/2.1/2.1/Covid19Tab/doc/estrutura_MP2_versao_1.3.xlsx)
...
![Link para download do modelo padrão MP5 versão 1.1](https://github.com/csis2/Covid19Tab/blob/2.1/2.1/Covid19Tab/doc/estrutura_MP5_versao_1.1.xlsx)
