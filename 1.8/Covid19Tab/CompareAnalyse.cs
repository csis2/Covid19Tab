...
namespace Covid19Tab
{
    ...
    // com o resultado da comparação chamado de "comp_return.prn".
    {
        ...
        {
            String cFilex = @"c:\covid19tab\1.8\covid19tab\tmp\heading_ready.txt";                     
            String cFiley = "";
            switch(Program.cModeloPadrao)
            {
                case "MP1":
                String cFiley2 = @"c:\covid19tab\1.8\covid19tab\mod\heading_model_MP1.c19";
                cFiley = cFiley2;
                break;
                case "MP2":
                String cFiley3 = @"c:\covid19tab\1.8\covid19tab\mod\heading_model_MP2.c19";
                cFiley = cFiley3;
                break;
                case "MP3":
                String cFiley4 = @"c:\covid19tab\1.8\covid19tab\mod\heading_model_MP3.c19";
                cFiley = cFiley4;
                break;
                case "MP4":
                String cFiley5 = @"c:\covid19tab\1.8\covid19tab\mod\heading_model_MP4.c19";
                cFiley = cFiley5;
                break;
            }

            String cResult = @"c:\covid19tab\1.8\covid19tab\tmp\comp_return.prn";
            ...
            if (!File.Exists(@"c:\covid19tab\1.8\covid19tab\tmp\comp_return.prn"))
            {
                Program.nErro = 1;
